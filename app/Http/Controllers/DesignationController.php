...
Class DesignationController extends Controller{
	...
	public function index(Designation $designation){
		...
		$top_designations = Designation::whereIn('id',getDesignation(\Auth::user(),1))->get()->pluck('full_designation','id')->all();
	...
	public function lists(Request $request){
		...
		elseif(Entrust::can('manage-subordinate-designation')){
			$child_designations = childDesignation(\Auth::user()->designation_id,1);
	...
	public function edit(Designation $designation){
		...
		$child_designations = childDesignation($designation->id);
