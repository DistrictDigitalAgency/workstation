...
Class TodoController extends Controller{
	...
	public function update(TodoRequest $request, Todo $todo){
		...
		return redirect('/home')->withSuccess(trans('messages.to_do').' '.trans('messages.updated'));
	}
	...
	public function destroy(Todo $todo){
        ...
        return redirect('/home')->withSuccess(trans('messages.to_do').' '.trans('messages.deleted'));
	}
}
?>