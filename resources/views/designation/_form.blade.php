			  ...
			  <div class="form-group">
				...
				{!! Form::select('department_id', $departments,isset($designation->department_id) ? $designation->department_id : '',['class'=>'form-control input-xlarge show-tick','title' => trans('messages.select_one')])!!}
			  </div>
			  <div class="form-group">
			    {!! Form::label('top_designation_id',trans('messages.top').' '.trans('messages.designation'),[])!!}
				{!! Form::select('top_designation_id', $top_designations,(isset($designation->top_designation_id)) ? $designation->top_designation_id : '',['class'=>'form-control input-xlarge show-tick','title' => trans('messages.select_one'),'id' => 'top_designation_id'])!!}
			  </div>
			  <div class="form-group">
