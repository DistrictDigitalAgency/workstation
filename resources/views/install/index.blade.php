@extends('layouts.guest')
	...
	@section('content')
		...
		<a class="btn btn-success btn-sm pull-right" style='margin:15px;' role="button" href="/update">Update</a>
		<div class="full-content-center animated fadeInDownBig" style="max-width:800px;">
			<div class="login-wrap">
				<div class="box-info full">
				
					{!! Form::open(['route' => 'install.store','class' => 'install-form','id' => 'myWizard','data-redirect' => '/login'])!!}
