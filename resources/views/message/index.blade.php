				        ...
				        <div id="myTabContent" class="tab-content col-md-10 col-xs-10" style="padding:0px 25px 10px 25px;">
						  <div class="tab-pane animated fadeInRight" id="compose-tab">
						    <div class="user-profile-content-wm">
                    			...
                    			{!! Form::open(['files'=>'true','route' => 'message.store','role' => 'form', 'class'=>'compose-form','id' => 'compose-form','data-redirect' => '/message']) !!}
									<div class="form-group">
										{!! Form::select('to_user_id', $users, '',['class'=>'form-control input-xlarge show-tick','title'=>trans('messages.select_one')])!!}
									</div>
									<div class="form-group">
						  ...
						  <div class="tab-pane active animated fadeInRight" id="inbox-tab">
						    <div class="user-profile-content-wm">
