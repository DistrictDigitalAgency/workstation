						    ...
						    <div class="user-profile-content-wm">
						    	...
						    	{!! Form::model($localization,['method' => 'PATCH','route' => ['localization.plugin',$locale] ,'class' => 'localization-plugin-form','id'=>'localization-plugin-form','data-no-form-clear' => 1]) !!}
								  <div class="form-group">
									...
									{!! Form::select('datatable', config('locale_datatable'),isset($locale) ? config('lang.'.$locale.'.datatable') : '',['class'=>'form-control input-xlarge show-tick','title'=>trans('messages.select_one')])!!}
								  </div>
								  <div class="form-group">
								    {!! Form::label('calendar',trans('messages.calendar').' '.trans('messages.localization'),[])!!}
									{!! Form::select('calendar', config('locale_calendar'),isset($locale) ? config('lang.'.$locale.'.calendar') : '',['class'=>'form-control input-xlarge show-tick','title'=>trans('messages.select_one')])!!}
								  </div>
								  <div class="form-group">
								    {!! Form::label('datepicker',trans('messages.datepicker').' '.trans('messages.localization'),[])!!}
									{!! Form::select('datepicker', config('locale_datepicker'),isset($locale) ? config('lang.'.$locale.'.datepicker') : '',['class'=>'form-control input-xlarge show-tick','title'=>trans('messages.select_one')])!!}
								  </div>
								  <div class="form-group">
								    {!! Form::label('datetimepicker',trans('messages.datetimepicker').' '.trans('messages.localization'),[])!!}
									{!! Form::select('datetimepicker', config('locale_datetimepicker'),isset($locale) ? config('lang.'.$locale.'.datetimepicker') : '',['class'=>'form-control input-xlarge show-tick','title'=>trans('messages.select_one')])!!}
								  </div>
								  <div class="form-group">
								    {!! Form::label('validation',trans('messages.validation').' '.trans('messages.localization'),[])!!}
									{!! Form::select('validation', config('locale_validation'),isset($locale) ? config('lang.'.$locale.'.validation') : '',['class'=>'form-control input-xlarge show-tick','title'=>trans('messages.select_one')])!!}
								  </div>
